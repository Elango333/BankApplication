...
public class ConstantFile {
	...
	public static String insert_query_for_creditcardDetails = "insert into Creditcard (CustomerID, CurrentBalance, CVV, CardHolderName, ValidFrom, ValidTo, ServiceChargePerc, RepayAmount) values (?, ?, ?, ?, ?, ?, ?, ?)";
	public static String insert_query_for_debitcardDetails = "insert into Debitcard (CustomerID, CurrentBalance, CVV, CardHolderName, ValidFrom, ValidTo) values (?, ?, ?, ?, ?, ?)";
	...
	public static String select_query_for_getDebitcardDetails = "select DebitcardNumber, CVV, CardHolderName, ValidFrom, ValidTo from Debitcard where DebitcardNumber = ?";
	public static String select_query_for_getCreditcardDetails = "select CreditcardNumber, CVV, CardHolderName, ValidFrom, ValidTo from Creditcard where CreditcardNumber = ?";
	public static String select_query_for_isPasswordCreatedForDebitcard = "select Password from Debitcard where DebitcardNumber = ?";
	public static String select_query_for_isPasswordCreatedForCreditcard = "select Password from Creditcard where CreditcardNumber = ?";
	public static String select_query_for_setPasswordForDebitcard = "update Debitcard set Password = ? where DebitcardNumber = ?";
	public static String select_query_for_setPasswordForCreditcard = "update Creditcard set Password = ? where CreditcardNumber = ?";
	public static String select_query_for_debitcardPin = "select Password from Debitcard where DebitcardNumber = ?";
	public static String select_query_for_creditcardPin = "select Password from Creditcard where CreditcardNumber = ?";
